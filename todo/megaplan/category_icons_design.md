...
export const CategoryIcon = ({ category, size = 'medium', className = '' }) => {
  ...
  const sizeClass = size === 'small' ? 'category-icon-small' : 
                   size === 'large' ? 'category-icon-large' : 
                   size === 'xl' ? 'category-icon-xl' : '';
...
```javascript
const iconPaths = {
  'coffee-shop': '<path d="M18 6h-1a4 4 0 0 0-4 4v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V10a4 4 0 0 0-4-4H2"/><path d="M6 6h12"/><path d="M18 10h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2"/><path d="M8 14h.01"/><path d="M8 18h.01"/>',
  ...
  'gas-station': '<path d="M5 12V4a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v4"/><path d="M5 12v8a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-8"/><path d="M9 8v2"/><path d="M19 2v10l-2 2v6a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-8"/><path d="M19 8h3"/>',
  ...
  'utilities': '<path d="M15 3v4a3 3 0 0 0 3 3v9a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V10a3 3 0 0 0 3-3V3"/><path d="M9 3v4a3 3 0 0 0 3 3"/><path d="M9 12v6"/><path d="M12 12v6"/><path d="M15 12v6"/>',
  ...
  'medical': '<path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"/><path d="M12 8v8"/><path d="M8 12h8"/>',
  'salary': '<line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>',
  'gifts': '<rect x="3" y="8" width="18" height="4" rx="1"/><path d="M12 8v13"/><path d="M8 21h8"/><path d="M12 8V2h0a2 2 0 0 1 2 2v4"/>',
  'miscellaneous': '<circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/>'
};
```
