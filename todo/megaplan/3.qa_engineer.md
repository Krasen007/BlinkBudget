...
- [x] **Task:** Test on real devices (iOS/Android/Tablets).
- [x] **Task:** Verify touch target sizes using browser dev tools overlays.
- [x] **Task:** Verify virtual keyboard behavior (does it hide inputs?).
