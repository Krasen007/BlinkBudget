...
```css
.smart-amount-input { /* Enhanced amount input */ }
.smart-suggestion-chips { /* Amount suggestion chips */ }
.smart-category-selector { /* Enhanced category grid */ }
.smart-match-highlight { /* Highlighted suggestion */ }
.smart-note-field { /* Enhanced note input */ }
.smart-suggestion-list { /* Note suggestions */ }
.confidence-indicator { /* Match confidence levels */ }
.merchant-recognition { /* Identified merchant display */ }
```
...
const suggestionData = {
  amount: {
    commonValues: [4.50, 5.00, 12.00, 25.00],
    timeBased: {
      morning: [4.50, 5.00], // Coffee, breakfast
      noon: [12.00, 15.00], // Lunch
      evening: [25.00, 40.00] // Dinner, entertainment
    },
    categoryBased: {
      'Food & Drink': [4.50, 12.00, 25.00],
      'Transport': [15.00, 25.00, 50.00],
      'Groceries': [50.00, 100.00, 150.00]
    }
  },
  category: {
    timePatterns: {
