module.exports = {
  ...
  rules: {
    ...
    'selector-class-pattern': [
      '^[a-z][a-z0-9]*(-[a-z0-9]+)*(__[a-z0-9]+(-[a-z0-9]+)*)?(--[a-z0-9]+(-[a-z0-9]+)*)?$|^([a-z]+:)+[a-z0-9]*(-[a-z0-9]+)*$',
      {
        message: 'Selector should be kebab-case or BEM-style, or a responsive variant like "md:class-name"'
      }
    ],
