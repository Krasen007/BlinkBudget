...
- **Tags System**: Add custom tags to transactions for flexible organization and analysis beyond categories | src/utils/form-utils/transaction-tags.js:createTransactionTagSelector() | src/utils/form-utils/transaction-tags.js:applyExpenseTagToTransactionData() | src/views/DashboardView.js:tag filtering
