...
import { sanitizeInput, validatePasswordStrength, validateEmail } from '../src/utils/security-utils';
...
describe('Advanced Security', () => {
    ...
    test('Strict Length Validation', () => {
        ...
        expect(validateLength('too long string', 5, 'Test').error).toContain('is too long');
    });
});
