...
vi.mock('../src/core/investment-tracker.js', () => ({
    InvestmentTracker: {
        getAllInvestments: vi.fn().mockReturnValue([
...
describe('AccountDeletionService', () => {
    ...
    describe('initiateAccountDeletion', () => {
        ...
        it('should handle Firebase unavailability gracefully', async () => {
            ...
            expect(result.warnings).toContain('Firebase not available, skipping authentication deletion');
        });
    ...
    describe('error handling', () => {
        it('should handle transaction deletion failures gracefully', async () => {
            ...
            expect(result.warnings).toContain('Transaction deletion failed: Transaction service unavailable');
        });
        ...
        it('should handle verification failures', async () => {
            ...
            // Assert
            expect(result.success).toBe(true); // Should still succeed
            expect(result.warnings).toContain('User still appears to be authenticated');
        });
    });
