...
export const FinancialPlanningView = () => {
  ...
  function renderInvestmentsSection() {
    ...
    // Current price field for manual updates
    ...
    function generateTypeSpecificFields(investmentType) {
    ...
    generateTypeSpecificFields('stocks');
    ...
    saveInvBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        notesInput.value = '';
        generateTypeSpecificFields('stocks'); // Reset type-specific fields
      } catch (err) {
    ...
    typeSelect.addEventListener('change', () => {
      generateTypeSpecificFields(typeSelect.value);
      validateInvForm();
    });
