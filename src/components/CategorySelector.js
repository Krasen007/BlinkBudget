 ...
 * @returns {HTMLElement}
 */
export const CategorySelector = (currentData, categoryColorMap, getCategoryColors, onCategoryClick) => {
    ...
    currentData.categoryBreakdown.categories.forEach((category, index) => {
        const card = CategoryCard(category, index, categoryColorMap, getCategoryColors, onCategoryClick);
