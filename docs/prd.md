...
3.  **Action 1: Launch BlinkBudget (Click 1):** The user taps the BlinkBudget app icon. The app launches *instantly*, presenting a clean, prominent interface focused on "Add Expense." This immediate readiness sets the "extremely fast" tone.
...
*   **Rapid Expense Entry (3-Click Max)**
    ...
    *   *Constraint*: The entire process from app launch to saved entry must not exceed three distinct user taps/clicks.
*   **Income Tracking**
