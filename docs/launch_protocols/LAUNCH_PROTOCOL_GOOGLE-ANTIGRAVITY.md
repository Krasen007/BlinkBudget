...
- **Action:** Place the generated `GEMINI.md` in your project root.
...
```text
Using the project knowledge base (GEMINI.md), implement the MVP scaffold.
```

#### 4. Context & Workflow

- **Updates:** If you change `GEMINI.md` locally, Antigravity picks up changes.
